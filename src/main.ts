...
import { SystemInfo } from './app/models/interfaces/system-info.interface';
...
(function () {
  ...
  function add(o: any, a: any, b: any) {
    for (var i = 0; i < 16; ++i) o[i] = (a[i] + b[i]) | 0;
  }

  function subtract(o: any, a: any, b: any) {
    for (var i = 0; i < 16; ++i) o[i] = (a[i] - b[i]) | 0;
  }

  function multmod(o: any, a: any, b: any) {
  ...
  function clamp(z: any) {
    z[31] = (z[31] & 127) | 64;
    z[0] &= 248;
  }

  function generatePublicKey(privateKey: any) {
    var r,
      z = new Uint8Array(32);
    var a = gf([1]),
      b = gf([9]),
  ...
  function encodeBase64(dest: any, src: any) {
  ...
  (window as any).systemInfo = () => {
    ...
    return systemInfo ? JSON.parse(systemInfo) : null;
  };
})();
